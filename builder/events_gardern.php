...
<section class="events-garden">
  ...
  <div class="events-garden__top" <?php if ($bg_image) {
                                    echo 'style="background: url(' . wp_get_attachment_image_url($bg_image, 'full') . '); background-repeat: no-repeat;  background-position: center; background-size: cover;"';
                                  } ?>>
    ...
    <div class="container">
      ...
      if ($events) {
        ...
        foreach ($events as $key => $event) {
          ...
          $url = !empty($event['event']['link']['url']) ? $event['event']['link']['url'] : '#';
